export default {
  ...
  admin: {
    ...
    localShare: {
      title: '本地分享',
      subtitle: '浏览 data/local 里的 NAS 文件，直接生成提取码，不会复制或占用快递柜存储。',
      mountHint: '把 NAS 目录挂到容器的 /app/data/local 即可在此浏览。例如：-v /volume1/share:/app/data/local:ro',
      refresh: '刷新',
      root: '根目录',
      empty: '当前目录没有可分享的文件或文件夹',
      ...
      share: '生成提取码',
      delete: '删除',
      deleteConfirm: '确定删除本地文件“{name}”？这会删除 data/local 中的原文件。',
      shareTitle: '分享本地文件',
      shareHint: '分享后原文件仍留在 NAS 目录。提取码过期或删除不会删除原文件。',
      expire: '有效期',
      expireValue: '数值',
      resultTitle: '提取码已生成',
      copyCode: '复制提取码',
      ...
      loadFailed: '本地目录加载失败',
      shareFailed: '生成提取码失败',
      shareSuccess: '已生成提取码 {code}',
      deleteSuccess: '已删除本地文件',
      deleteFailed: '删除失败'
    },
    settings: {
      title: '系统设置',
  ...
  send: {
    ...
    messages: {
      ...
      guestUploadBlockedTitle: '本站需登录后上传',
      guestUploadBlockedDesc: '当前站点已关闭游客上传，请先登录管理员账号再上传文件。',
      guestUploadBlockedAction: '去登录',
