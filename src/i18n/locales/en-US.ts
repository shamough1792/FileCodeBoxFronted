export default {
  ...
  admin: {
    ...
    localShare: {
      title: 'Local Share',
      subtitle: 'Browse NAS files in data/local and mint extract codes without copying them into FileCodeBox storage.',
      mountHint: 'Mount your NAS folder to /app/data/local. Example: -v /volume1/share:/app/data/local:ro',
      refresh: 'Refresh',
      root: 'Root',
      empty: 'No files or folders in this directory',
      ...
      share: 'Create code',
      delete: 'Delete',
      deleteConfirm: 'Delete local file “{name}”? This removes the original file under data/local.',
      shareTitle: 'Share local file',
      shareHint: 'The original file stays on the NAS. Expiring or deleting the code will not delete it.',
      expire: 'Expiration',
      expireValue: 'Value',
      resultTitle: 'Extract code created',
      copyCode: 'Copy code',
      copyLink: 'Copy retrieve link',
      openFiles: 'Open share records',
      loadFailed: 'Failed to load local directory',
      shareFailed: 'Failed to create extract code',
      shareSuccess: 'Created extract code {code}',
      deleteSuccess: 'Local file deleted',
      deleteFailed: 'Delete failed'
    },
    settings: {
  ...
  send: {
    ...
    messages: {
      ...
      guestUploadBlockedTitle: 'Login required to upload',
      guestUploadBlockedDesc: 'Guest upload is disabled on this site. Please sign in with the admin account first.',
      guestUploadBlockedAction: 'Go to login',
